...
<div class="container">
    <div class="row p-3 d-flex justify-content-center">
        ...
        <div class="col-md-11 p-3 mt-5 shadow">
            <form action="update_testimonial_title.php" method="post" id="socialMediaForm" >
                <div class="col-md-12">
                ...
                <div class="col col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputEmail4" placeholder="Enter Title" required name="test_title" value="<?= $row['test_title'] ?>">
                </div>
                <div class="col col-md-6">
                    <label for="inputEmail4" class="form-label">Title Description</label>
                    <textarea class="form-control" id="inputEmail4" required name="title_desc" placeholder="Enter Title Description"><?= $row['title_desc'] ?></textarea>
                </div>
                </div>
                <div class="row my-4">
        ...
        <div class="col-md-11 p-3 mt-5 shadow">
            <form action="testimonial_data.php" method="post" id="socialMediaForm" enctype="multipart/form-data">
                <div class="col-md-12">
                    <h4>Testimonies</h4>
                    <hr>
                </div>
                ...
                <div class="col col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputEmail4" placeholder="Enter Customer Name" required name="cus_name">
                </div>
                <div class="col col-md-6">
                    <label for="inputEmail4" class="form-label">Customer Disease</label>
                    <input type="text" class="form-control" id="inputEmail4" placeholder="Enter Customer Dieseas" required name="cus_dise">
                </div>
                </div>
                <div class="row my-5">
                <div class="col col-md-6">
                    <label for="inputEmail4" class="form-label">Customer Review</label>
                    <textarea class="form-control" id="inputEmail4" required name="cus_rev" placeholder="Enter Customer Review"></textarea>
                </div>
                <div class="col col-md-6">
                    <label for="inputEmail4" class="form-label">Customer Image</label>
                    <input type="file" class="form-control" id="inputEmail4" required name="cus_image">
                </div>
                </div>
                <div class="row my-4">
                    <div class="col-md-12 text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="d-flex justify-content-space-between">
                            <a href="edit_testimonial.php?test_id=<?= $row['test_id'] ?>">
                                <button class="btn btn-primary btn-sm">
                                    <i class="ri-pencil-line"></i>
                                </button>
                            </a>&nbsp;
                            <a href="delete_testimonial.php?test_id=<?= $row['test_id'] ?>">
                        ...
                        <td><?= $key+1 ?></td>
                        <td class="p-3">
                            <img src="../public/upload_image/testimonial/<?= $row['cus_image'] ?>" style="height:150px;width:150px" alt="">
                        </td>
                        <td><?= $row['cus_name'] ?></td>
                        <td><?= $row['cus_dise'] ?></td>
                        <td><?= $row['cus_rev'] ?></td>
